...
//todo: Доповни функцію calculateTotalBalance(users) таким чином, щоб вона рахувала і повертала суму всіх коштів (властивість balance), які зберігають користувачі з масиву users.
...
const calculateTotalBalance = users => {
  ...
  console.log(users.reduce((total, { balance }) => (total += balance), 0));
};
...
console.log('calculateTotalBalance: ', calculateTotalBalance);
