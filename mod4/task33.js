...
//todo: Доповни функцію isAnyUserActive(users) таким чином, щоб вона перевіряла наявність активних користувачів (властивість isActive) і повертала true або false.
...
const isAnyUserActive = users => {
  console.log(users.some(({ isActive }) => isActive === true));
};
