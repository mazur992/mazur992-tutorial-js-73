...
//todo: Доповни функцію getInactiveUsers(users) таким чином, щоб вона повертала масив неактивних користувачів, значення властивості isActive яких - false.
...
const getInactiveUsers = users => {
  console.log(users.filter(({ isActive }) => isActive === false));
};
