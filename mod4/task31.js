...
//todo: Доповни функцію isEveryUserActive(users) таким чином, щоб вона перевіряла, чи всі користувачі зараз активні (властивість isActive) і повертала true або false.
...
const isEveryUserActive = users => {
  console.log(users.every(({ isActive }) => isActive === true));
};
